...
+ export PATH 
+ exec mktemp -d 
td=/tmp/tmp.c0jxBz2zIT
ev=1
+ trap /bin/rm -rf $td; exit $ev 0 
+ : 
+ /bin/ln /tmp/tmp.c0jxBz2zIT/file1 /tmp/tmp.c0jxBz2zIT/file2 
+ test /tmp/tmp.c0jxBz2zIT/file1 -ef /tmp/tmp.c0jxBz2zIT/file2 
portabilitytest/12_test_test_ef: test: unknown operator -ef
+ /bin/rm -rf /tmp/tmp.c0jxBz2zIT 
+ exit 1 
#+END_SRC
...
+ export PATH 
+ exec mktemp -d 
td=/tmp/tmp.JRT7eJ1WlC
ev=1
+ : 
+ test /tmp/tmp.JRT7eJ1WlC/newfile -nt portabilitytest/13_test_test_nt 
